...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Alex Kolpakov", "2Screentransitions", "2Screentransitions", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "2 Screen transitions", null, { width: 800, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			background: Std.int (65280),
			borderless: false,
			company: "Alex Kolpakov",
			depthBuffer: false,
			file: "2Screentransitions",
			fps: Std.int (60),
			fullscreen: false,
			height: Std.int (480),
			orientation: "",
			packageName: "2Screentransitions",
			resizable: true,
			stencilBuffer: false,
			title: "2 Screen transitions",
			version: "1.0.0",
			vsync: false,
			width: Std.int (800),
